(function (global, factory) {
  ...
  function (
    ...
    var createOrFindInTop__default =
      /*#__PURE__*/ _interopDefaultLegacy(createOrFindInTop);
...
***************************************************************************** */
    ...
    var getOwnPropertyDescriptor$1 = function getOwnPropertyDescriptor(
      it,
      key
    ) {
      ...
      for (var i = 1; i < arguments.length; i++) {
        ...
        if (typeof getOwnPropertySymbols === "function") {
          ownKeys = ownKeys.concat(
            getOwnPropertySymbols(source).filter(function (sym) {
    ...
    var lib = createCommonjsModule(function (module, exports) {
      ...
      function createLoading() {
        ...
        var extraReducers = (0, _defineProperty2.default)(
          {},
          namespace,
          function () {
            var state =
            ...
            switch (type) {
              case SHOW:
                ret = (0, _objectSpread6.default)({}, state, {
                  global: true,
                  models: (0, _objectSpread6.default)(
                    {},
                    state.models,
                    (0, _defineProperty2.default)({}, namespace, true)
                  ),
                  effects: (0, _objectSpread6.default)(
                    {},
                    state.effects,
                    (0, _defineProperty2.default)({}, actionType, true)
                  ),
                });
                break;
              ...
              case HIDE:
                // eslint-disable-line
                var effects = (0, _objectSpread6.default)(
                  {},
                  state.effects,
                  (0, _defineProperty2.default)({}, actionType, false)
                );
                var models = (0, _objectSpread6.default)(
                  {},
                  state.models,
                  (0, _defineProperty2.default)(
                    {},
                    namespace,
                    (0, _keys.default)(effects).some(function (actionType) {
                ...
                var global = (0, _keys.default)(models).some(function (
                  namespace
                ) {
...
***************************************************************************** */
    ...
    function createThemePlugin() {
      ...
      try {
        if (top !== self) {
          if (top[STORE_KEY$1]) initialState = top[STORE_KEY$1];
        } else {
      ...
      try {
         ...
         */
        if (top === self) {
          var onAction = function (store) {
            return function (next) {
              return function (action) {
                if (action.type === SET$1) {
                  var state = __assign$1(
                    __assign$1({}, store.getState()[NAMESPACE$1]),
                    action.payload
                  );
                  /**
         ...
         */
        var themeEnhancer = function (storeCreator) {
...
***************************************************************************** */
    ...
    var getIsAdmin = function (roles) {
      ...
      return (
        roles.findIndex(function (role) {
          return String(role).endsWith("01");
        }) !== -1
      );
    };
    ...
    var compatibilityMe = function (me) {
      ...
      return __assign(
        {
          admin: getIsAdmin(me === null || me === void 0 ? void 0 : me.roles),
          adminAreaId:
            (_a = me === null || me === void 0 ? void 0 : me.org) === null ||
            _a === void 0
              ? void 0
              : _a.areaId,
          adminAreaName:
            (_b = me === null || me === void 0 ? void 0 : me.org) === null ||
            _b === void 0
              ? void 0
              : _b.areaName,
          maintainPlatId:
            (_c =
              me === null || me === void 0
                ? void 0
                : me.additionalInformation) === null || _c === void 0
              ? void 0
              : _c.mpi,
          orgId:
            (_d = me === null || me === void 0 ? void 0 : me.org) === null ||
            _d === void 0
              ? void 0
              : _d.orgId,
          orgName:
            (_e = me === null || me === void 0 ? void 0 : me.org) === null ||
            _e === void 0
              ? void 0
              : _e.orgName,
          orgType:
            (_f = me === null || me === void 0 ? void 0 : me.org) === null ||
            _f === void 0
              ? void 0
              : _f.orgType,
          userName: me === null || me === void 0 ? void 0 : me.realName,
          userTypes: (me === null || me === void 0 ? void 0 : me.roles)
            ? me === null || me === void 0
              ? void 0
              : me.roles.join(",")
            : undefined,
          deptRole:
            (_g =
              me === null || me === void 0
                ? void 0
                : me.additionalInformation) === null || _g === void 0
              ? void 0
              : _g.deptRole,
          isBidDown:
            (_h =
              me === null || me === void 0
                ? void 0
                : me.additionalInformation) === null || _h === void 0
              ? void 0
              : _h.isBidDown,
          isSj:
            (_j =
              me === null || me === void 0
                ? void 0
                : me.additionalInformation) === null || _j === void 0
              ? void 0
              : _j.isSj,
          orgClassNo:
            (_k =
              me === null || me === void 0
                ? void 0
                : me.additionalInformation) === null || _k === void 0
              ? void 0
              : _k.orgClassNo,
          organClass:
            (_l =
              me === null || me === void 0
                ? void 0
                : me.additionalInformation) === null || _l === void 0
              ? void 0
              : _l.organClass,
          userType:
            (_m =
              me === null || me === void 0
                ? void 0
                : me.additionalInformation) === null || _m === void 0
              ? void 0
              : _m.userType,
        },
        me
    ...
    function createGlobalContextPlugin(opts) {
      ...
      try {
        if (top && top !== self) {
          if (top[STORE_KEY]) initialState = top[STORE_KEY];
          /**
           * 标记子应用
           */
          initialState.env.inApp = opts.appName || true;
        } else if (top) top[STORE_KEY] = initialState;
      } catch (e) {
        // do nothing
      }
      var extraReducers =
      ...
      try {
        ...
        if (top === self) {
          var onAction = function (store) {
            return function (next) {
              return function (action) {
                if (action.type === SET) {
                  var state = __assign(
                    __assign({}, store.getState()[NAMESPACE]),
                    action.payload
                  );
                  /**
                   * 保存 state 到 window[STORE_KEY]
                   */
                  if (top) top[STORE_KEY] = state;
                  /**
                   * 发送事件通知子应用 state 改变了
                   */
          ...
          var loadDataEnhancer = function (storeCreator) {
            return function (reducer, preloadedState, enhancer) {
              var store = storeCreator(reducer, preloadedState, enhancer);
              /**
               * 加载登录用户信息
              ...
              if (opts.notLoadMe !== true) {
                axios__default["default"]({
                  ...
                  function (response) {
                    store.dispatch({
                      type: SET,
                      payload: { me: compatibilityMe(response.data) },
                    });
                  },
                  function (error) {
                    var _a;
              ...
              if (opts.djcGatewayBaseUrl) {
                ...
                axios__default["default"]({
                  ...
                  params: {
                    orgDomainName: opts.origin
                      ? parseUrl(opts.origin).host
                ...
                // eslint-disable-next-line no-console
                console.error(
                  "dva-global-context-plugin: 参数 djcGatewayBaseUrl 未指定, 平台信息无法加载"
                );
              }
              return store;
            };
          ...
          return {
            onAction: onAction,
            extraReducers: extraReducers,
            extraEnhancers: [loadDataEnhancer],
          };
        }
        /**
         * 在子应用中
         * 接受改变事件通知, 修改 state
         */
        var handleChangeEnhancer = function (storeCreator) {
          return function (reducer, preloadedState, enhancer) {
            var store = storeCreator(reducer, preloadedState, enhancer);
        ...
        return {
          extraReducers: extraReducers,
          extraEnhancers: [handleChangeEnhancer],
        };
      } catch (e) {
        // eslint-disable-next-line no-console
    ...
    var globalSelector = function (state) {
      return state[NAMESPACE];
    };
    var useGlobal = function () {
      return reactRedux.useSelector(globalSelector);
    };
    ...
    // eslint-disable-next-line no-console
    var defaultOnError = function (err) {
    ...
    function createStateContainer(_a) {
      var _b = _a === void 0 ? {} : _a,
        history = _b.history,
        _c = _b.NODE_ENV,
        NODE_ENV = _c === void 0 ? "production" : _c,
        _d = _b.onError,
        onError = _d === void 0 ? defaultOnError : _d,
        _e = _b.useThemePlugin,
        useThemePlugin = _e === void 0 ? true : _e,
        _f = _b.useGlobalContextPlugin,
        useGlobalContextPlugin = _f === void 0 ? false : _f,
        globalContextOpts = _b.globalContextOpts;
