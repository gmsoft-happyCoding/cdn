/*
   ...
   版本 V1.4.0  2019-11-01
        增加显示证书信息UI的接口
   版本 V1.5.0  2020-03-03
        增加获取SignedData属性信息的接口
        2021-04-30 修改显示调用中间件捕获的异常
*/
...
var NetcaPKI = (function () {
  ...
  WebSocketManager.prototype.RegisterPromise = function (promiseObj, params) {
    ...
    var sendData = JSON.stringify({
      ...
      // "requestOrigin":"001DE133-9BD7-4ACE-BF4D-AE14D689C061",
  ...
  WebSocketManager.prototype.ProcessSuccessMessageCallBack = function (
    message
  ) {
    //判断是否正常数据
    try {
  ...
  WebSocketManager.prototype.ProcessServiceConnectFailCallBack = function (
    jsonMessage,
    addMsg
  ) {
    if (addMsg == null || addMsg == "") {
      addMsg = "数字证书服务连接失败，请确认已安装最新的数字证书驱动!";
    }
  ...
  WebSocketManager.prototype.WebSocketDoSend = function (jsonMessage) {
    ...
    if (selfObject._wsObj != null && selfObject._isWsConnecting) {
      selfObject.ProcessServiceConnectFailCallBack(
        jsonMessage,
        "数字证书服务连接中,请稍后重试!"
      );
    ...
    if (selfObject._wsObj != null && selfObject._wsObj.readyState == 1) {
      ...
      if (connectInfoItem == null) {
        ...
        selfObject.ProcessServiceConnectFailCallBack(
          jsonMessage,
          "数字证书服务连接失败，请确认已安装最新的数字证书驱动!"
        );
        // alert("数字证书服务连接失败，请确认已安装最新的数字证书驱动!");
        return;
      }
      ...
      try {
        ...
        //开始连接
        selfObject._wsObj = new WebSocket(
          connectConfig.url,
          connectConfig.subprotocol
        );
  ...
  WebSocketManager.prototype.ProcessSynMessageCallBack = function (
    message,
    synpromise
  ) {
    //判断是否正常数据
    try {
      ...
      //没有办法定位是哪个实例，只是默认不处理该信息
      obj = JSON.parse(
        '{"responseResult": {"status":-1,"msg": "响应的数据不是有效的JSON数据"}}'
      );
      // 打印调用中间件服务发生的异常
      console.log(e.stack);
      synpromise.FireEvent(null, obj.responseResult);
  ...
  WebSocketManager.prototype.SendRPCMessage = function (params) {
    ...
    if (IsUseWebsocket()) {
      ...
      try {
        ...
        var NETCA_ERROR_WEBSOCKETCONNECTFAIL = -11000;
        this.ProcessSynMessageCallBack(
          createSynCallBackJsonString(
            "创建NetcaPki对象失败",
            NETCA_ERROR_WEBSOCKETCONNECTFAIL
          ),
          retSynPromise
        );
      ...
      try {
        ...
        if (-2146827850 == e.number) {
          //对象不支持此属性或方法
          exceptionStr = "当前NETCA_Crypto版本可能过低,请确保版本正常";
        } else {
          exceptionStr = "调用NetcaPki.Utilities接口异常";
        }
  ...
  function initializeObject(obj) {
    ...
    //尝试列表
    var TryList = ["wss://127.0.0.1:10443", "wss://127.0.0.1:20443"];
  ...
  PKIObject.checkPKIInstall = function (params) {
    ...
    if (IsUseWebsocket()) {
      ...
      requestQueryParams["function"] = "GetVersionInfo";
      requestQueryParams["param"] = params;
      var sendMsg = _PkiMgr.RegisterPromise(retSynPromise, requestQueryParams);
      ...
      try {
        ...
        var NETCA_ERROR_WEBSOCKETCONNECTFAIL = -11000;
        _PkiMgr.ProcessSynMessageCallBack(
          createSynCallBackJsonString(
            "数字证书服务连接失败(1)，请确认已安装最新的数字证书驱动",
            NETCA_ERROR_WEBSOCKETCONNECTFAIL
          ),
          retSynPromise
        );
      ...
      //加载成功 调用接口
      try {
        var retString = comObj.CryptoJsonRpcCallBack(sendMsg);
        _PkiMgr.ProcessSynMessageCallBack(retString, retSynPromise);
        return retSynPromise;
      } catch (e) {
        var NETCA_ERROR_WEBSOCKETCONNECTFAIL = -11000;
        _PkiMgr.ProcessSynMessageCallBack(
          createSynCallBackJsonString(
            "数字证书服务连接失败(2)，请确认已安装最新的数字证书驱动",
            NETCA_ERROR_WEBSOCKETCONNECTFAIL
          ),
          retSynPromise
        );
  ...
  PKIObject.signHash = function (params) {
    var requestQueryParams = {};
    requestQueryParams["function"] = "SignHash";
    requestQueryParams["param"] = params;
    return SendNetcaCryptoJsonRpcMessage(requestQueryParams);
  };
  ...
  PKIObject.kdf = function (params) {
    var requestQueryParams = {};
    requestQueryParams["function"] = "Kdf";
    requestQueryParams["param"] = params;
    return SendNetcaCryptoJsonRpcMessage(requestQueryParams);
  };

  PKIObject.getDeviceSupportedSignAlgorithm = function (params) {
    var requestQueryParams = {};
    requestQueryParams["function"] = "GetDeviceSupportedSignAlgorithm";
    requestQueryParams["param"] = params;
    return SendNetcaCryptoJsonRpcMessage(requestQueryParams);
  };

  PKIObject.readStreamWithNetca = function (params) {
    var requestQueryParams = {};
    requestQueryParams["appName"] = "SignatureCreator";
  ...
  PKIObject.readStream = function (params) {
    var requestQueryParams = {};
    requestQueryParams["appName"] = "SignatureCreator";
    requestQueryParams["function"] = "ReadStream";
    requestQueryParams["param"] = params;
  ...
  PKIObject.writeSeal = function (params) {
    var requestQueryParams = {};
  ...
  PKIObject.readSeal = function (params) {
    var requestQueryParams = {};
  ...
  PKIObject.deleteSeal = function (params) {
    var requestQueryParams = {};
  ...
  PKIObject.sesStampDecode = function (params) {
    var requestQueryParams = {};
  ...
  PKIObject.deleteCertificate = function (params) {
    var requestQueryParams = {};
    requestQueryParams["function"] = "DeleteCertificate";
    requestQueryParams["param"] = params;
    return NetcaPKI.SendNetcaCryptoJsonRpcMessage(requestQueryParams);
  };

  PKIObject.deleteKeypair = function (params) {
    var requestQueryParams = {};
    requestQueryParams["function"] = "DeleteKeypair";
    requestQueryParams["param"] = params;
    return NetcaPKI.SendNetcaCryptoJsonRpcMessage(requestQueryParams);
  };
 ...
 */
function netca_publicKeyEncryptFile(
  selectType,
  selectCondition,
  publicKeyEncFilePath,
  SuccessPublicKeyEncryptFileCallBack,
  FailedPublicKeyEncryptFileCallBack
) {
  var params = {
    cert: {
...
tbs,要加密的文本
 */
function netca_publicKeyEncryptText(
  selectType,
  selectCondition,
  tbs,
  SuccessPublicKeyEncryptFileCallBack,
 ...
 */
function netca_privateKeyDecrypt(
  selectType,
  selectCondition,
  cipherData,
  savefile,
  SuccessPrivateKeyDecryptCallBack,
  FailedPrivateKeyDecryptCallBack
) {
  var params = {
    cert: {
      type: selectType,
...
function netca_signedDataVerify(
  verifyLevel,
  signValue,
  tbs,
  SuccessSignedDataVerifyCallBack,
  FailedSignedDataVerifyCallBack
) {
  var params = {
...
function netca_envelopedDataEncryptFile(
  certCode,
  selectType,
  selectCondition,
  _fieldName,
...
function netca_envelopedDataEncryptText(
  certCode,
  selectType,
  selectCondition,
  clearText,
...
function netca_envelopedDataDecrypt(
  encData,
  saveFile,
  SuccessEnvDecryptCallBack,
  FailedEnvDecryptCallBack
) {
  var params = {
...
function netca_AutoSignPosition(
  _hashAlgo,
  src_File,
  dest_File,
  revInfoInclude,
...
function netca_getCertStringAttribute(
  certEncode,
  selectType,
  selectCondition,
  attId,
...
function netca_Custom_PdfSignAndUpload(
  certEncode,
  pageNum,
  x,
  y,
...
function netca_Custom_PdfSignAndUploadURL(
  certEncode,
  pageNum,
  x,
  y,
...
//获取签章
//参数是证书编码
function netca_getSealImage(
  certEncode,
  SuccessGetSealImageCallBack,
  FailedGetSealImageCallBack
) {
  var params = {
    cert: {
      encode: certEncode,
...
function netca_getCertStringExtensionValue(
  certEncode,
  selectType,
  selectCondition,
  oidString,
...
//获取版本号相关信息
function netca_getVersionInfo(
  SuccessGetVersionInfoCallBack,
...
//获取客户端KeyX版本号相关信息
function netca_getClientVersionInfo(
  SuccessGetVersionInfoCallBack,
  FailedGetVersionInfoCallBack
) {
  var params = {};
...
//监控设备插拔
function netca_monitorDevice(
  _delayTime,
  SuccessMonitorDeviceCallBack,
 ...
 */
function netca_verifySignature(
  certEncode,
  selectType,
  selectCondition,
  signAlgo,
  origindata,
  signValue,
  SuccessSignVerifyCallBack,
  FailedSignVerifyCallBack
) {
  var params = {
    cert: {
      encode: certEncode,
...
并将结果保存到目标文件中。
 */
function netca_SignatureCreator_PdfSignSealField(
  _srcFile,
  _srcBytes,
  _destFile,
  _certEncode,
  ...
  _tsaPwd,
  _tsaHashAlgo,
  _SignatureCreatorSuccessCallBack,
  _SignatureCreatorFailedCallBack
) {
  var params = {
...
function netca_SignatureCreator_PdfSignSealPosition(
  _srcFile,
  _srcBytes,
  _destFile,
  _certEncode,
...
function netca_SignatureCreator_PdfSignSealFieldEx(
  _srcFile,
  _srcBytes,
  _destFile,
  _certEncode,
...
function netca_SignatureCreator_PdfSignSealPositionEx(
  _srcFile,
  _srcBytes,
  _destFile,
  _certEncode,
...
function netca_SignatureCreator_SealKeyWord(
  _srcFile,
  _srcBytes,
  _destFile,
  _certEncode,
...
function netca_verifyCertificate(
  _certEncode,
  _bUseCrl,
  _bUseOcsp,
  _crlEncode,
...
function netca_signatureVerifierVerifyPDF(
  _srcFile,
  _srcBytes,
  _level,
  successCallBack,
...
function netca_signatureVerifierUndoPDF(
  _signFile,
  _signBytes,
  _index,
  successCallBack,
...
function netca_certauth_verifyCert(
  serverUrl,
  certEncode,
  selectType,
  selectCondition,
...
function netca_certauth_chkonecert(
  serverUrl,
  certEncode,
  selectType,
  selectCondition,
...
function netca_getSignatureFieldInfo(
  _srcFile,
  _srcBytes,
  successCallBack,
  failedCallBack
...
function netca_installCertificate(
  _sn,
  _type,
  _encKeypair,
  _encCert,
