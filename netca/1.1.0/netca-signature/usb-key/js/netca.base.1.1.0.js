                    ...
                    if (obj.responseResult.status == 0) {
                        if (messageItem.promiseCallBack.successCallBack != null) {
                            ...
                            catch (e)
                            {
                                if(e.fileName){
                                    // firefox
                                    alert("错误文件："+e.fileName+"； 行数:"+e.lineNumber+"； 错误类型:"+e.name+"； 错误信息:"+e.message);
                                } else {
                                    // chrome
                                    alert(e.message);
                                }
    ...
    WebSocketManager.prototype.WebSocketDoSend = function (jsonMessage) {
        ...
        if (selfObject._wsObj != null && selfObject._wsObj.readyState == 1) {
            ...
            if (connectInfoItem == null) {
                ...
                selfObject.ProcessServiceConnectFailCallBack(jsonMessage,"数字证书服务连接失败，请确认已安装最新的数字证书驱动!");
    ...
    WebSocketManager.prototype.SendRPCMessage = function (params) {
        ...
        if (IsUseWebsocket()) {
            ...
            try {
                ...
                var NETCA_ERROR_WEBSOCKETCONNECTFAIL=-11000;
                this.ProcessSynMessageCallBack(createSynCallBackJsonString("创建NetcaPki对象失败", NETCA_ERROR_WEBSOCKETCONNECTFAIL),retSynPromise);
            ...
            try {
                ...
                var NETCA_ERROR_WEBSOCKETCONNECTFAIL=-11000;
                this.ProcessSynMessageCallBack(createSynCallBackJsonString(exceptionStr, NETCA_ERROR_WEBSOCKETCONNECTFAIL),retSynPromise);
                return retSynPromise;
            }
    ...
    PKIObject.checkPKIInstall = function (params)
    {
        ...
        else
        {
            ...
            try {
                ...
                var NETCA_ERROR_WEBSOCKETCONNECTFAIL=-11000;
                _PkiMgr.ProcessSynMessageCallBack(createSynCallBackJsonString("数字证书服务连接失败(1)，请确认已安装最新的数字证书驱动", NETCA_ERROR_WEBSOCKETCONNECTFAIL),retSynPromise);
                return retSynPromise;
            }
            ...
            try {
                ...
                var NETCA_ERROR_WEBSOCKETCONNECTFAIL=-11000;
                _PkiMgr.ProcessSynMessageCallBack(createSynCallBackJsonString("数字证书服务连接失败(2)，请确认已安装最新的数字证书驱动", NETCA_ERROR_WEBSOCKETCONNECTFAIL),retSynPromise);
                return retSynPromise;
