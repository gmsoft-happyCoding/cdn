...
(function (document) {
  ...
  Wind.prototype.fnCreate = function(){
    ...
    var html = '<div class="title"><span>'+ this.setting.title+'</span><a class="close">X</a></div><div class="content" id="selfDialogContent"></div><div class="footer" id="selfDialogFooter">';
    var _buttons = this.setting.buttons;
    if(_buttons){
        for(var i=0;i<_buttons.length;i++){
            html += '<div class="btnWrapper"><input id="dialogBtn'+i+'" class="btn" type="button" value="'+_buttons[i].text+'"/></div>';
        }
    }
