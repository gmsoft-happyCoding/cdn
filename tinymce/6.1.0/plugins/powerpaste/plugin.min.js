...
!(function () {
  ...
  const K = (e) => parseInt(e, 10),
    ...
    pe = (e) => {
      ...
      return tinymce.explode(
        null !== (t = e.options.get("images_file_types")) && void 0 !== t
          ? t
          : ""
      );
    },
    ...
    be = (e, t) => ((void 0 !== e[t] && null !== e[t]) || (e[t] = {}), e[t]),
    xe = (e, t) =>
      ((e, t) => {
        let n = void 0 !== t ? t : ye;
        for (let t = 0; t < e.length; ++t) n = be(n, e[t]);
        return n;
      })(e.split("."), t),
    ...
    st = rt,
    at = (m(Ze), m(Qe), m("IE"), m(et), m(tt), m(nt), "Windows"),
    it = "Android",
    lt = "Linux",
    ct = "macOS",
    ut = "Solaris",
    ...
    : (e, t, n) => {
        ...
        return (
          ...
          }),
          {
            ...
            cleanDocument: (e, t, n) =>
              o.then((r) =>
                r.cleanDocument(e, t, n.cleanFilteredInlineElements)
              ),
          }
        );
      };
  const St = (e) => {
    ...
    It = (e, t) => {
      ...
      return (1 !== (r = n).nodeType &&
        ...
        ? []
        : A(n.querySelectorAll(e), De.fromDom);
      var r;
    },
    At = (e, t) => e.dom === t.dom,
    Ot = Tt,
  ...
  const Pt = (e, t, n, r) => ({
    ...
    an = (e) => {
      if (null === e.anchorNode || null === e.focusNode) return sn(e);
      {
        ...
        return ((e, t, n, r) => {
          ...
          ? k.some(Pt(t, e.anchorOffset, n, e.focusOffset))
          : sn(e);
      }
    },
    ln = (e) =>
  ...
  const kn = (e) => {
    ...
    Gn = (e, t) => {
      const n = e.dom;
      Un(n, t), Rn(In(e, "style").map(G), "") && On(e, "style");
    },
    qn = (e) => ("rtl" === Hn(e, "direction") ? "rtl" : "ltr"),
    Kn = (e, t) => {
      const n = (t || document).createElement("div");
      return (n.innerHTML = e), Ht(De.fromDom(n));
    },
        ...
        contents: () => (
          ((e, t) => {
            Bt(e)
              ...
              O(Ht(e), (e) => {
                ((e) => Te(e) && !e.dom.hasChildNodes() && T(ar, ke(e)))(e) &&
                  vn(e);
              });
          })(n, o),
          {
    ...
    const n = Ct({
      ...
      r = ((e) => {
        ...
        return {
          ...
          toOn: (t, o) => {
            ...
            n.each((n) => {
              const r = ((e) => e.dom.childNodes.length)(t),
                o =
                  At(t, n.startContainer()) && r < n.startOffset()
                    ? r
                    : n.startOffset(),
                a =
                  At(t, n.endContainer()) && r < n.endOffset()
                    ? r
                    : n.endOffset(),
          ...
          toOff: (o, s) => {
            const a = r(s);
            hn(s, t), (n = e.get(a)), e.set(a, bn(t, 0, t, 0));
          },
        };
      })(hr),
      o = ((e, t, n) => {
  ...
  const pr = tr("ephox-cement").resolve,
              ...
              n(
                t.fold(
                  (t) =>
                    Ir.error(
                      t +
                        'Unable to download editor stylesheets from "' +
                        e +
                        '"'
                    ),
                  Ir.value
          ...
          a = [
            Lr(s, "load", (e) => {
              ((e) => {
                ...
                try {
                  const n =
                    null === (t = e.target.dom.sheet) || void 0 === t
                      ? void 0
                      : t.cssRules;
          ...
          e.getOrSetIndexed(t, () =>
            ((e) =>
              yr.nu((t) => {
                ...
                const o = Lr(r, "error", () => {
                    n(), t(Ir.error("Error loading external script tag " + e));
                  }),
                  s = Lr(r, "load", n);
    ...
    Jr = (e, t) => {
      const n = Hr(e.bundle, t.bundle),
        r = ((e, t) =>
          Mr(e, k.none, k.none, k.none, (e, n, r) =>
            Mr(
              t,
              k.none,
              (e, t) => k.some(Rr.incomplete(e, t, r)),
              k.none,
              k.none
            )
    ...
    Xr =
      ...
      (...e) => {
        ...
        for (let n = 0; n < e.length; n++) {
          const r = e[n];
          for (const e in r) ze(r, e) && (t[e] = Zr(t[e], r[e]));
        }
        return t;
      });
  var Zr;
  const Qr = Nt([
    ...
    io = (e, t) => {
      ...
      ((e, t, n) => {
        ...
        const r = Be(t),
          o = Be(n);
        if (0 === r && 0 === o) On(e, "style");
        else if (0 === r) Sn(e, "style", so(n));
        else {
          Me(t, (t, n) => {
            Bn(e, n, t);
          });
                  ...
                  return (
                    !s && e.firstChild
                      ...
                      ? e.nextSibling
                        ...
                        : ((r = o.pop()), (s = !0))
                      : (s = !0),
                    a === bo || r || (t.body.removeChild(n), (r = bo)),
    ...
    Ao = (e, t) => {
      if (void 0 === e || void 0 === t)
        throw (console.trace(), new Error("brick"));
      e.nextFilter.set(t);
    },
    Oo = (e, t, n = !1) =>
      e === t ||
    ...
    Lo = (e, t, n, r) => {
      ...
      return ((a = r.emblems()),
      (i = s),
      _(a, (e) => "ul" === e.tag || (l(i) && Oo(e, i, !0))).orThunk(() =>
        U(a)
      )).filter(
        (e) =>
          !(
    ...
    No = (e) => (t, n, r) => {
      ...
      const a = ((e, t, n) => (
        Lo(n.listType.get(), e, n.emitter, t).each(n.listType.set),
        ((e, t, n) => ({
          level: m(e),
          token: m(t),
          type: m(n),
        }))(t.level(), n.originalToken.get(), n.listType.get())
      ))(o, s, n);
      n.emitter.openItem(a.level(), a.token(), a.type()), Ao(n, e.inside());
    },
    _o = (e, t, n) => ({
      pred: e,
      action: t,
            ...
            : ((e, t, n, r) => {
                const o = n > 1 ? jo(e) : Ro(e, k.none()),
                  s = o
                    ...
                    .getOr([]),
                  a = ((e, t, n, r) =>
                    ((e, t, n) => Fo(e, (e) => e.level() < t, n))(e, n, (e) =>
                      ((e, t, n, r) => {
                        const o =
                            e.level() === n - 1 && t.type
                              ? {
  ...
  const Xo = {
    ...
    Zo = (() => {
      ...
      return {
        check: (t) =>
          !(!e || t.type() !== po) ||
          (t.type() === ho && "style" === t.tag()
            ? ((e = !0), !0)
            : t.type() === mo && "style" === t.tag() && ((e = !1), !0)),
      };
    })(),
    Qo = ((e) =>
      Do(
    ...
    es = ((e) =>
      Do(
        "Outside.List.Item",
        [
          _o(Eo, No(e), "Data List ****"),
          _o(
            (e, t) =>
              t.type() === po &&
              ((e) => e.type() === po && /^[\s\u00A0]*$/.test(e.text()))(t),
            (e, t, n) => {
              e.emit(n);
            },
            "Whitespace"
        ...
        (t, n, r) => {
          n.emitter.closeAllLists(), t.emit(r), Ao(n, e.outside());
        }
      ))(Xo),
    ts = ((e) => {
      const t = fe(e),
  ...
  const rs = (e) => e.dom.textContent,
    ...
    hs = (e) =>
      Zn(e, (e) => !!(Te(e) ? oo(e, ["mso-list"], b) : {})["mso-list"]),
    ms = (e) =>
      Te(e) &&
      $n(e, "font-family").exists((e) =>
        T(["wingdings", "symbol"], e.toLowerCase())
      ),
    ps = (e, t, n, r) => {
      ((e, t, n) => {
        ...
        ((e) => {
          const t = ((e, t) => {
            ...
            return ((e) => {
              const t = [];
              for (; null !== e.nextNode(); ) t.push(De.fromDom(e.currentNode));
              return t;
            })(
            ...
            "p" !== ke(e)
              ...
              : hs(e).bind((t) => {
                  const n = Ft(t).getOr(t),
                    r = ms(n);
                  return us(t, r).bind((t) =>
                    ((e) =>
                      $n(e, "margin-left").bind((e) => {
                        const t = parseInt(e, 10);
                        return isNaN(t)
                          ? k.none()
                          : k.some(Math.max(1, Math.ceil(t / 18)));
                      }))(e).map((r) => ({
                      mutate: () => {
                        ps(e, r, t, [n]);
                      },
  ...
  const ks = (e) => (t) => {
      ...
      return "currentcolor" === e || "transparent" === e
        ...
        : "#" +
            ...
            ((e) => Ss.test(e) || Cs.test(e))(t)
              ...
              .orThunk(() =>
                ((e) => {
                  if ("transparent" === e) return k.some(Ls(0, 0, 0, 0));
                  const t = Os.exec(e);
                  if (null !== t) return k.some(Ns(t[1], t[2], t[3], "1"));
                  const n = Es.exec(e);
                  return null !== n
                    ? k.some(Ns(n[1], n[2], n[3], n[4]))
                    : k.none();
                })(e).map(As)
              )
              .getOrThunk(() => {
      ...
      tags: [
        {
          ...
          condition: (e) =>
            In(e, "id").exists((e) => $(e, "docs-internal-guid")),
        },
      ],
    }),
    js = ko({
        ...
        tags: [
          {
            ...
            mutate: (t) => {
              ...
              ((n = Vn(t)),
              (r = e.key),
              ze(n, r) ? k.from(n[r]) : k.none()).exists((t) =>
                T(e.values, t)
              ) &&
                (mn(t, De.fromTag(e.newTag)),
                Gn(t, e.key),
    ...
    zs = (e) => (t) => {
      ...
      const s = A(n, (e) => {
        const { fake: t, me: n } = e,
          ...
          s = Ue(o, (e, r) => {
            const o = ((e, t) =>
                T(_s, t) ? $n(e, "background-repeat") : k.none())(n, r).getOr(
                e
              ),
              s = ((e, t) =>
                T(_s, t) ? Hn(e, "background-repeat") : Hn(e, t))(t, r);
      ...
      tags: [
        {
          ...
          condition: (e) => {
            ...
            return (
              t("text-indent") +
                t("rtl" === n ? "padding-right" : "padding-left") ===
              0
            );
          },
          mutate: (e) => {
    ...
    Js = (e) => {
      ...
      return (
        null == t || 0 === t.length || (1 === t.length && "style" === t[0].name)
      );
    },
    Ys = (e, t) => {
      ...
      const o = Ht(t);
      return fn(n, o), vn(t), n;
    },
    Xs = Ee("li"),
    Zs = (e) =>
      Ut(e).bind((e) =>
        Ie(e) && 0 === Ks(e).trim().length
          ? Zs(e)
          : Xs(e)
          ? k.some(e)
          : k.none()
    ...
    ra = ko({
      styles: [
        {
          name: no.not(
            no.pattern(/^(width|height|list-style-type)$/, no.caseInsensitive)
          ),
        ...
        },
        {
          ...
          condition: (e) => {
            return (
              ((e) => "img" !== ke(e))(e) && !("table" === ke((t = e)) || ws(t))
            );
            var t;
          },
        },
  ...
  const pa = So({
    ...
    fa = (e) => {
      const t = Ys("span", e);
      _n(t, "ephox-limbo-transform"), Bn(t, "text-decoration", "underline");
    },
    ga = So({
      tags: [
        {
              ...
              T(["ol", "ul"], n) &&
                Zs(e).fold(
                  () => {
                    ...
                    Bn(t, "list-style-type", "none"), mn(e, t);
                  },
                  (t) => {
                    hn(t, e);
                  }
        ...
        tags: [
          {
            ...
            mutate: (e) => {
              "\xa0" === rs(e) &&
                (t(e) || n(e) ? yn(e) : (cn(e, De.fromText(" ")), vn(e)));
            },
          },
        ],
      });
    ...
    Ca = (() => {
      ...
      return So({
        tags: [
          e("a", "data-ephox-href", "href"),
          e("img", "data-ephox-src", "src"),
        ],
      });
    })(),
    Ta = (e) => {
      ...
      r.each((n) => {
        o.each((r) => {
          ...
          for (; void 0 !== a && !At(a, e); )
            T(t, ke(a)) ? (o = a) : s.push(a), (a = Ft(a).getOrUndefined());
          O(s, yn), O(zt(o), vn);
        }),
          vn(n);
      }),
      ...
      tags: [
        {
          ...
          mutate: (e) => {
            $n(e, "margin-left").exists((e) => $(e, "-")) &&
              Gn(e, "margin-left"),
              $(Hn(e, "margin-left"), "-") &&
                (Bn(e, "margin-top", Hn(e, "margin-top")),
    ...
    Oa = (e, t) => {
      return ((n = e), qs.getOption(n)).exists((e) => 0 === t(e).length);
      var n;
    },
    Ea = ko({
      tags: [
  ...
  const Ua = (e) => {
    ...
    $a = (e, t) =>
      e.type === xs.GoogleDocs
        ? [Ws, ...Bs, ...Fs, zs(t), $s, Vs, ...Wa(e)]
        : [],
  ...
  const qa = (e, t) => Ya(document.createElement("canvas"), e, t),
    Ka = (e) => {
      ...
      return Ja(t).drawImage(e, 0, 0), t;
    },
    Ja = (e) => e.getContext("2d"),
    Ya = (e, t, n) => ((e.width = t), (e.height = n), e),
    ...
    ai = (e, t, n) => {
      const r = t.type,
        ...
        a = (t, n) =>
          e.then((e) =>
            ((e, t, n) => ((t = t || "image/png"), e.toDataURL(t, n)))(e, t, n)
          );
      return {
        getType: o,
    ...
    ii = (e, t) =>
      ni(e, t).then((t) => ai(Promise.resolve(e), t, e.toDataURL())),
    li = (e, t, n) => {
      const r = Xa(e),
        o = Za(e);
      let s = t / r,
    ...
    ci = (e, t, n) =>
      new Promise((r) => {
        const o = Xa(e),
          ...
          i = Math.floor(s * n),
          l = qa(a, i);
        Ja(l).drawImage(e, 0, 0, o, s, 0, 0, a, i), r(l);
      }),
    ui = (e, t = 2) => {
    ...
    di = (e, t, n, r, o) =>
      ((e, t, n, r, o) =>
        e.toCanvas().then((s) =>
          ((e, t, n, r, o, s) => {
            const a = qa(o, s);
            return Ja(a).drawImage(e, -n, -r), ii(a, t);
          })(s, e.getType(), t, n, r, o)
        ))(e, t, n, r, o),
    hi = (e, t) =>
      ((e, t) =>
    ...
    vi = (e) => parseInt(e, 10),
    yi = (e) =>
      e.isPx && (e.cropWidth !== e.width || e.cropHeight !== e.height),
    bi = /rotate\((\d\.\d+)rad\)/,
    xi = (e, t, n) =>
      pi(e.dom)
        .then(
            ...
            (e) => (t) =>
              ((e, t, n) =>
                ((e, t, n) =>
                  e
                    .toCanvas()
                    .then((r) => li(r, t, n).then((t) => ii(t, e.getType()))))(
                  e,
                  t,
                  n
                ))(t, e.width, e.height)
        ...
        .then(
          ((e, t) => (n) => {
            if (yi(t)) {
              ...
              return di(n, o, r, t.cropWidth, t.cropHeight).then(
                (n) => (
                  Cn(e, {
                    width: t.cropWidth,
                    height: t.cropHeight,
          ...
          (
            (e, t) => (n) =>
              ((e) => {
                ...
                return k
                  .from(bi.exec(t))
                  .map((e) => Math.round(parseFloat(e[1]) * (180 / Math.PI)));
              })(t).fold(
                () => Promise.resolve(n),
                (r) =>
                  hi(n, r).then(
                    (n) => (
                      Gn(t, "transform"), On(e, "width"), On(e, "height"), n
                    )
                  )
              )
          )(e, n)
        ...
        .then((t) => {
          const n = gi(t);
          return Sn(e, "src", n), Promise.resolve();
        }),
    ki = (e) =>
      Ft(e)
        .filter(Ee("span"))
  ...
  const Si = (e, t) => D(e, (e) => e.start === t),
      ...
      return ((e) => {
        ...
        return N(
          ...
          (e, t) => {
            ...
            return D(e, (e) => t.start === e.start).fold(
              () => (n ? e : [...e, t]),
    ...
    ji = m([]),
    Fi = (e, t, n) => {
      if (e.property().isText(t)) return [Mi.text(t, e)];
      if (e.property().isEmptyTag(t)) return [Mi.empty(t, e)];
              ...
              o = L(
                ((e, t) => {
                  ...
                  const n = N(
                    ...
                    r = t[t.length - 1];
                  return r < e.length
                    ? n.values.concat(e.substring(r))
                    : n.values;
                })(r, n),
                (e) => e.length > 0
              );
            if (o.length <= 1) return [Ai(t, 0, r.length)];
        ...
        const n = ((e, t, n) => {
            ...
            return r
              .bind((t) => {
                const r = o.getOr(
                  ((e, t) =>
                    e[e.length - 1] && e[e.length - 1].finish === t
                      ? e.length + 1
                      : -1)(e, n)
                );
          ...
          ((e, t) => {
            k.from(e[0])
              ...
              .map((n) => {
                ...
                return cn(n, r), fn(r, e), Sn(r, "href", t), r;
              });
          })(e.elements, r);
        }
      });
  ...
  function _l(e, t, n) {
    var r;
    (n = null !== (r = n) && void 0 !== r ? r : Sl), cl && cl(e, null);
  ...
  function Dl(e) {
    var t,
      n = fl(null);
    for (t in e) !0 === vl(ll, e, [t]) && (n[t] = e[t]);
    return n;
  }
  function Pl(e, t) {
    for (; null !== e; ) {
      var n = hl(e, t);
      if (n) {
        if (n.get) return Nl(n.get);
        if ("function" == typeof n.value) return Nl(n.value);
      }
      e = dl(e);
    }
    return function (e) {
          ...
          (Ce && Ce === e) ||
            ...
            (ke =
              "ALLOWED_NAMESPACES" in e
                ? _l({}, e.ALLOWED_NAMESPACES, Cl)
                : we),
            (pe =
              "ADD_URI_SAFE_ATTR" in e
                ? _l(Dl(fe), e.ADD_URI_SAFE_ATTR, _)
                : fe),
            (he =
              "ADD_DATA_URI_TAGS" in e
                ? _l(Dl(me), e.ADD_DATA_URI_TAGS, _)
                : me),
            ...
            ce &&
              ((z = _l({}, al(zl))),
              (W = []),
              !0 === ce.html && (_l(z, Rl), _l(W, Hl)),
              !0 === ce.svg && (_l(z, Ml), _l(W, Wl), _l(W, Vl)),
              !0 === ce.svgFilters && (_l(z, jl), _l(W, Wl), _l(W, Vl)),
              !0 === ce.mathMl && (_l(z, Ul), _l(W, $l), _l(W, Vl))),
            e.ADD_TAGS && (z === H && (z = Dl(z)), _l(z, e.ADD_TAGS, _)),
            e.ADD_ATTR && (W === $ && (W = Dl(W)), _l(W, e.ADD_ATTR, _)),
            e.ADD_URI_SAFE_ATTR && _l(pe, e.ADD_URI_SAFE_ATTR, _),
            e.FORBID_CONTENTS &&
              (ue === de && (ue = Dl(ue)), _l(ue, e.FORBID_CONTENTS, _)),
            ie && (z["#text"] = !0),
            Q && _l(z, ["html", "head", "body"]),
            z.table && (_l(z, ["tbody"]), delete G.tbody),
            ml && ml(e),
            (Ce = e));
        },
      ...
      var De = function (e) {
        ...
        Ue = function (e) {
          ...
          if (
            ...
            return De(e), !0;
          if (El(/[\u0080-\uFFFF]/, e.nodeName)) return De(e), !0;
          var o = _(e.nodeName);
          if (
            (Fe("uponSanitizeElement", e, {
              tagName: o,
              allowedTags: z,
            }),
            e.hasChildNodes() &&
              ...
              El(/<[/\w]/g, e.innerHTML) &&
              El(/<[/\w]/g, e.textContent))
          )
            return De(e), !0;
          if ("select" === o && El(/<template/i, e.innerHTML)) return De(e), !0;
          if (!z[o] || G[o]) {
            if (!G[o] && ze(o)) {
          ...
          return e instanceof l &&
            ...
            : ("noscript" !== o && "noembed" !== o && "noframes" !== o) ||
              !El(/<\/no(script|embed|frames)/i, e.innerHTML)
            ? (Z &&
                3 === e.nodeType &&
                ((t = e.textContent),
                (t = Il(t, D, " ")),
      ...
      return (
        (n.sanitize = function (e) {
          var o,
            ...
            d =
              arguments.length > 1 && void 0 !== arguments[1]
                ...
                : {};
          if (
            ((xe = !e) && (e = "\x3c!--\x3e"), "string" != typeof e && !je(e))
          ) {
          ...
          if (
            ...
            (1 ===
              (a = (o = Re("\x3c!----\x3e")).ownerDocument.importNode(e, !0))
                .nodeType &&
              "BODY" === a.nodeName) ||
            "HTML" === a.nodeName
              ? (o = a)
          ...
          if (ne) {
            ...
            return (
              (W.shadowroot || W.shadowrootmod) && (u = O.call(r, u, !0)), u
            );
          }
          ...
          return (
            Q &&
              ...
              El(ec, o.ownerDocument.doctype.name) &&
              (p = "<!DOCTYPE " + o.ownerDocument.doctype.name + ">\n" + p),
            Z &&
              ((p = Il(p, D, " ")), (p = Il(p, P, " ")), (p = Il(p, R, " "))),
        ...
        (n.addHook = function (e, t) {
          "function" == typeof t && ((L[e] = L[e] || []), wl(L[e], t));
        }),
        (n.removeHook = function (e) {
          if (L[e]) return kl(L[e]);
        }),
  ...
  const rc = ["script", "svg"],
        ...
        e(t)
          ...
          : ((e, t) => {
              nc.addHook("uponSanitizeElement", (e, t) => {
                T(rc, t.tagName) ||
                  ze(t.allowedTags, t.tagName) ||
                  (t.allowedTags[t.tagName] = !0);
              }),
                nc.addHook("uponSanitizeAttribute", (e, t) => {
                  0 === t.attrName.indexOf("on") ||
                    ze(t.allowedAttributes, t.attrName) ||
              ...
              return (
                nc.removeHook("uponSanitizeElement"),
                nc.removeHook("uponSanitizeAttribute"),
                n
                  ? ((s = H(o, "<body>")),
                    V(s, "</body>")
                      ? ((e, t) => e.substring(0, e.length - 7))(s)
                      : s)
                  : o
              );
              var s;
    ...
    xc = (e) =>
      ((e) =>
        W(e, "<html") &&
        (W(e, 'xmlns:o="urn:schemas-microsoft-com:office:office"') ||
          W(e, 'xmlns:x="urn:schemas-microsoft-com:office:excel"')))(e) ||
      ((e) => W(e, 'meta name="ProgId" content="Word.Document"'))(e),
    ...
    Nc = (e, t, n) => {
      ...
      const s = (n, o) => {
        ...
        const s = ((e, t, n) => {
          const r = ((e, t) =>
            B(e, (e) =>
              e.getAvailable(t).map((t) => Kr(e.steps, t, e.label, e.capture()))
            ))(e, n);
          return r.getOrThunk(() => {
        ...
        const a = ((e, t) => {
            const n = {
              ...
              r = N(
                e,
                (e, n) => (qr(e) ? e.then((e) => Yr(e, t, n)) : Yr(e, t, n)),
                n
              );
        ...
        a.then((e) => {
          const t = e.bundle.isInternal.getOr(!1),
            n = e.bundle.officeStyles.fold(m("auto"), (e) =>
              e ? "merge" : "clean"
            );
          r.trigger.block(!1),
            Mr(
              ...
              (e, o, s) => {
                r.trigger.insert(e, Lc(o), o, t, i, n), r.trigger.error(s);
              }
            );
        });
      };
              ...
              const t = ((e, t = ac) => {
                const n = (e) => {
                    return void 0 === e.items
                      ? k.none()
                      : ((t = bc), (n = e.types), B(t, (e) => nl(n, e))).map(
                          (t) => {
                            const n = [];
                ...
                return {
                  ...
                  getOnlyText: () =>
                    Ic(e).bind((e) => {
                      return 1 === (t = e.types).length && "text/plain" === t[0]
                        ? r(e)
                        : k.none();
                      var t;
                    }),
  ...
  const Pc = (e) => {
    ...
    Vc = (e) =>
      R(zc(e), (e) => {
        ...
        return Hc(t)
          ? ((e, t) => {
              return ((n = t), ei(n)).map((t) => Bc(Pc(t), e));
              var n;
            })(e, t).toArray()
          : Wc(t)
          ? ((e, t) => {
          ...
          ? ((e) => {
              ...
              return r.then((t) => {
                ...
                return {
                  response:
                    r.errors.length > 0
                      ? Br(e, s, "errors.imageimport.failed")
                      : Fr(e, s),
                  bundle: n.bundle,
                };
              });
  ...
  const Kc = (e, t, n = !1) =>
    ...
    Xc = (e) => {
      const t = ((e) => {
        const t = _(Jc, (t) => e === t.code).fold(
          m("Unknown ImageProxy error"),
          (e) => e.message
        );
    ...
    Zc = (e) =>
      _(Yc, (t) => t.type === e).fold(
        m("Unknown service error"),
        (e) => e.message
      ),
    Qc = (e) =>
      ((e) =>
    ...
    eu = (e, t, n = !0) =>
      t
            ...
            return Kc(
              ((e, t) => {
                ...
                return /[?&]apiKey=/.test(e)
                  ? e
                  : e + n + "apiKey=" + encodeURIComponent(t);
              })(e, t),
              n
            ).then((e) => {
              return e.ok
        ...
        : ((e, t) =>
            Kc(e, {}, t).then((e) =>
              e.ok ? Promise.resolve(e.blob) : Xc(e.status)
            ))(e, n),
    tu =
      /^(?:([^:\/?#]+):)?(?:\/\/((?:(([^:@\/]*)(?::([^:@\/]*))?)?@)?([^:\/?#]*)(?::(\d*))?))?((((?:[^?#\/]*\/)*)([^?#]*))(?:\?([^#]*))?(?:#(.*))?)/,
    nu =
          ...
          return Promise.all(
            A(a, (e) => {
              ...
              return ((e) => {
                ...
                ? eu(e.dom.src, void 0, !0).then(r, () => ((s = !0), o(e, t)))
                : o(e, t);
            })
          ).then(
            (r) => {
    ...
    pu = (e, t) => {
      if (!qt(e))
        throw new Error(
          "Internal error: attempted to write to an iframe that is not in the DOM"
        );
      const n = ((e) =>
          ((e) => {
            const t = e.dom;
            try {
              ...
              return (
                console.log("Error reading iframe: ", t),
  ...
  var fu = Object.create,
    ...
    Tu = ku((e) => {
      ...
      function a(e, t) {
        ...
        var a = r(t),
          i = r(e);
        if ((i && (e = i.path || "/"), a && !a.scheme))
          return i && (a.scheme = i.scheme), o(a);
  ...
  function td(e, t) {
    ...
    if (
      ...
      Eu(n) && ((t = Zu(e, t + 1)), (n = e.charCodeAt(t))),
  ...
  function rd(e) {
    if (1 === e.length && !Lu(e.charCodeAt(0))) return e[0];
    let t = parseInt(e, 16);
    return (
    ...
    dd = class {
          ...
          this.offsetAndType = null,
            ...
            t(e, (e, t, c) => {
              switch (e) {
                ...
                case a: {
                  let e = i & ld;
                  for (i = o[e], a = i >> cd, o[s] = e, o[e++] = s; e < s; e++)
                    o[e] === n && (o[e] = s);
                  break;
                }
                case 21:
      ...
      lookupType(e) {
        return (e += this.tokenIndex) < this.tokenCount
          ? this.offsetAndType[e] >> cd
          : 0;
      }
      lookupOffset(e) {
        return (e += this.tokenIndex) < this.tokenCount
          ? this.offsetAndType[e - 1] & ld
          : this.source.length;
      }
      lookupValue(e, t) {
        return (
      ...
      getTokenStart(e) {
        return e === this.tokenIndex
          ...
          ? e < this.tokenCount
            ? this.offsetAndType[e - 1] & ld
            : this.offsetAndType[this.tokenCount] & ld
      ...
      skipUntilBalanced(e, t) {
        ...
        e: for (; o < this.tokenCount && ((n = this.balance[o]), !(n < e)); o++)
          switch (
            ((r =
              o > 0 ? this.offsetAndType[o - 1] & ld : this.firstCharOffset),
      ...
      for (t || (t = n(c++)), a = 5; c < e.length; c++) {
        ...
        switch (Gu(r)) {
          case t:
            return void c++;
          case Hu:
            if (Ru(r)) return (c += Ku(e, c, r)), void (a = 6);
            break;
          case 92:
  ...
  function Dd() {
    ...
    if (10 !== n) {
      if (!this.isDelim(Id, e) && !this.isDelim(Ad, e)) return null;
      t = this.isDelim(Id, e) ? Id : Ad;
      do {
        n = this.lookupType(++e);
      } while (13 === n || 25 === n);
      10 !== n && (this.skip(e), Nd.call(this, Ed));
    }
    return (
      e > 0 && this.skip(e),
      0 === t &&
  ...
  function Pd() {
    let e = this.tokenStart,
      t = null,
      n = null;
    if (10 === this.tokenType) Nd.call(this, !1), (n = this.consume(10));
    else if (1 === this.tokenType && this.cmpChar(this.tokenStart, Ad))
      switch (
        ((t = "-1"), _d.call(this, 1, Od), this.tokenEnd - this.tokenStart)
      ) {
        case 2:
          this.next(), (n = Dd.call(this));
          break;
        case 3:
          _d.call(this, 2, Ad),
            this.next(),
      ...
      1 === this.tokenType ||
      (this.isDelim(Id) && 1 === this.lookupType(1))
    ) {
      let r = 0;
      switch (
        ((t = "1"),
        this.isDelim(Id) && ((r = 1), this.next()),
        _d.call(this, 0, Od),
      ...
      s === this.tokenStart + o &&
        ...
        s + 1 === this.tokenEnd
          ? (this.next(), (n = Dd.call(this)))
          : (_d.call(this, s - this.tokenStart + 1, Ad),
            s + 2 === this.tokenEnd
              ? (this.next(),
                this.skipSC(),
                Nd.call(this, Ed),
                (n = "-" + this.consume(10)))
              : (Ld.call(this, s - this.tokenStart + 2, Ed),
                this.next(),
                (n = this.substrToCursor(s + 1))));
    } else this.error();
    return (
      null !== t && t.charCodeAt(0) === Id && (t = t.substr(1)),
  ...
  function $d() {
    ...
    return (
      this.isDelim(Ud)
        ? ((t = !0), this.next())
        : this.isDelim(Hd) || this.eat(1),
      this.isDelim(Hd)
        ? this.charCodeAt(this.tokenStart + 1) !== Bd
  ...
  function Vd() {
    ...
    return (
      ...
      this.next(),
      t !== Bd &&
        (this.isDelim(Bd) || this.error("Equal sign is expected"), this.next()),
  ...
  function Bh(e) {
    ...
    for (let n = r; n <= o; n++) {
      ...
      if (r === jh) {
        ...
        if (((r = e.charCodeAt(++n)), ju(jh, r))) {
          let t = n - 1,
            r = Qu(e, t);
          (n = r - 1), (s += rd(e.substring(t + 1, r)));
  ...
  function Gh() {
    ...
    return (
      this.isDelim(124)
        ? (this.next(), Vh.call(this))
        : (Vh.call(this), this.isDelim(124) && (this.next(), Vh.call(this))),
      {
        type: "TypeSelector",
        loc: this.getLocation(e, this.tokenStart),
        name: this.substrToCursor(e),
          ...
          n.sourceMap &&
            (s = (function (e) {
              ...
              e.node = function (e) {
                ...
                c.call(this, e),
                  l && fd.has(e.type) && ((o.line = a), (o.column = i));
              };
              let u = e.emit;
              e.emit = function (e, t, n) {
                for (let t = 0; t < e.length; t++)
                  10 === e.charCodeAt(t) ? (a++, (i = 0)) : i++;
                u(e, t, n);
              };
              let d = e.result;
              return (
  ...
  function um({ source: e, line: t, column: n }, r) {
    ...
    let s = e.split(/\r\n?|\n|\f/),
      ...
      c = 0;
    (n +=
      (cm.length - 1) * (s[t - 1].substr(0, n - 1).match(/\t/g) || []).length) >
      im && ((c = n - lm + 3), (n = lm - 2));
    for (let e = a; e <= i; e++)
      e >= 0 &&
        e < s.length &&
        ((s[e] = s[e].replace(/\t/g, cm)),
        (s[e] =
          (c > 0 && s[e].length > c ? "\u2026" : "") +
          s[e].substr(c, im - 2) +
          (s[e].length > c + im - 1 ? "\u2026" : "")));
    return [o(a, t), new Array(n + l + 2).join("-") + "^", o(t, i)]
      .filter(Boolean)
      .join("\n");
  }
  ...
  var wm = (function (e) {
            ...
            getLocationFromList(e) {
              if (r) {
                ...
                return a.getLocationRange(
                  null !== t
                    ? t.loc.start.offset - a.startOffset
                    : this.tokenStart,
                  null !== r
                    ? r.loc.end.offset - a.startOffset
                    : this.tokenStart,
                  n
                );
              }
    ...
    _m = (e) => {
      ...
      if ("Selector" === t.type) return [Nm(e)];
  ...
  const zm = {
    ...
    Hm = (e, t) => {
      ...
      if (
        ...
        O(n, (e) => {
          const t = Jt(e, "li");
          $n(e, "margin-top").isNone() &&
            k.from(t[0]).each((t) => {
              Bn(e, "margin-top", Hn(t, "margin-top"));
            }),
            $n(e, "margin-bottom").isNone() &&
    ...
    Wm = (e, t, n) => {
      const r = (e) =>
        In(e, "data-list-level")
          .map((e) => parseInt(e, 10))
          .getOr(1);
      return $n(e, "text-indent").bind((o) =>
        $n(e, "margin-left").map((s) => {
        ...
        ((n = De.fromDom(document.body)),
        {
          play: (e, t, r) => {
            ...
            const a = Lr(s, "load", () => {
              ...
              a.unbind(), pu(s, e);
              const i =
                null === (n = s.dom.contentWindow) || void 0 === n
                  ? void 0
                  : n.document;
              if (void 0 === i)
                throw new Error(
                  "sandbox iframe load event did not fire correctly"
                );
    ...
    Vm = (e, t, n, r) => {
      ...
      return n.cleanDocument(o, t, r).then(
        (e) => {
          ...
          {
            const n =
              void 0 === r.sanitizer ? sc(r.intraFlag.isMarked) : r.sanitizer;
            return ((e, t, n, r) => {
              const o = (e) => ({
                  response: e,
                  bundle: Wr({}),
              ...
              return $m(e)(s).then((e) => {
                const t = Kn(e),
                  ...
                  s = De.fromTag("div");
                fn(s, t);
                const a = L(It("img[src]", s), (e) =>
                    In(e, "src").exists((e) => $(e, "blob:") || $(e, "data:"))
                  ),
          ...
          const o = Jn(n),
            s = ((e, t) => {
                ...
                r = ((e, t) => {
                  const n = t.browser.isFirefox(),
                    r = Co([
                      ...
                      Io((e, t) => {
                        const n = ((e, t, n) =>
                          t(De.fromDom(e.getNode())).fold(
                            () => [e],
                            (t) => {
                              const r = e.type() === mo,
                                o = [go(t.dom, r)];
                              return !r && n && o.push(go(t.dom, !0)), o;
                            }
                          ))(t, s, a);
                        e.emitTokens(n);
                      }, d)),
              ...
              return P([
                ...
                Ha(t),
                r.annotate,
                ((o = n ? [] : t.cleanFilteredInlineElements), [Ea, Na, va(o)]),
                za(t),
                $a(t, e),
                [js],
                [ga],
    ...
    Ym = (e, t) => {
      const n = qm(() =>
        ((e, t) => ((e, t) => To(e, t, [ta, Ca]))(e, Jn(t)))(e, t)
      );
      return Km(n);
    },
    Xm = (e, t, n, r, o) =>
      Jm(e, t, r, n, o).fold(Vr, (e) =>
        Promise.resolve({
          response: Fr(e, []),
          bundle: Wr({}),
        })
        ...
        (r) => {
          ...
          return i
            ? ((e, t, n, r) => {
                ...
                return O(s, vn), Xm(e, n, o, !0, r);
              })(l, t, r, n)
            : ((e, t, n, r, o) => Xm(e, t, r, n, o))(l, r, o, a, n);
        }
      );
    },
    op = (e, t) => (n, r) => {
  ...
  const cp = Nt([
    ...
    yp = (e) => {
            ...
            return ((e) => {
              ...
              return ((e) =>
                e.indexOf("\\pngblip") >= 0
                  ...
                  ? Ir.value("image/jpeg")
                  : Ir.error("errors.imageimport.unsupported"))(t).fold(
                (e) => up.unsupported(a, e, r, o),
                (e) =>
                  ((e, t) => {
                    const n = e.match(t);
                    return n && n[1] && n[1].length % 2 == 0
                      ? Ir.value(n[1])
                      : Ir.error("errors.imageimport.invalid");
                  })(t, n).fold(
                    (e) => up.unsupported(a, e, r, o),
                    (t) =>
                      up.supported(
                        ...
                        ((e, t) => {
                          if (0 === e.length)
                            throw new Error(
                              "Zero length content passed to Hex conversion"
                            );
                          const n = ((e) => {
      ...
      let o = 0;
      for (; o < e.length; ) o = vp(e, o).fold(n, r);
      return t;
    },
    bp = (e) =>
      up.cata(
    ...
    Sp = (e, t, n, r, o) => {
      ...
      const l = R(e, (e, l) => {
        ...
        return (
          ...
          "unsupported" === c
            ? ((i = !0), Sn(e, "alt", n("errors.imageimport.unsupported")), [])
      ...
      const s = ((e) =>
          N(
            ...
            (e, t) => {
              const n = bp(t),
                r = xp(t);
              return D(e, (e) => !(r || xp(e)) && bp(e) === n).fold(
                () => e.concat([t]),
                (n) =>
                  kp(e[n]).isValue()
                    ? e
        ...
        { pass: l, fail: c } = E(
          e,
          (e) => !((e) => "true" === Tn(e, "data-ms-equation"))(e)
        ),
        ...
        /(tiff|pdf)$/.test(r.getType())
          ? ((e) =>
              ...
              t
                .map((t) => {
                  const n = e.image;
                  return URL.revokeObjectURL(o), Fc(t, n), jc(t, n);
                })
                .getOr(e)
            )
          : t(),
  ...
  var Op = (e, t) => {
    ...
    return Mr(
      ...
      (e, t, r) =>
        n(
          t,
          (t) => (console.error("PowerPaste error code:  IMG01"), Br(e, t, r))
        )
    );
  };
  const Ep = (e, t) => (e.isSupported ? t.getWordData() : k.none()),
          ...
          (e, t) =>
            new Promise((n, o) => {
              ...
              ((e, t) => {
                ...
                B(n, (n) => Mn(e.discriminator === n, t[n])).getOrDie(
    ...
    Hp = (e) =>
      jp(
        ...
        [
          !1 === e.allowLocalImages
            ? (e, t) => Vr("errors.local.images.disallowed")
            : (e, t) =>
                ((e) => {
                  const t = L(
                      e,
                      (e) => "file" === e.kind && /image/.test(e.type)
                    ),
                    n = N(
                      t,
                      (e, t) => {
                        ...
                        O(e, (e) =>
                          Dc.cata(
                            ...
                            (r, o, s) => {
                              ...
                              Sn(a, "src", s), t.push(a), n.push(jc(e, a));
                            },
                            (e, t, n) => {
                              console.error(
                  ...
                  gc(e).getOrDie("Must have image data for images handler")
                    .images
                ),
          Op,
        ],
  ...
  const Gp = {
    ...
    nf = (e, t) =>
      ef(t).bind((t) =>
        !1 === e.selection.isCollapsed() && Qp(t.url)
          ? ((e, t) =>
              tf(e, t.html, () => {
    ...
    lf = (e, t, n, r, o, s) => {
      const a = ge(),
        i = (null == r ? void 0 : r.jsUrl)
          ? r.jsUrl
          : ("/js", n.replace(/\/$/, "") + "/" + "/js".replace(/^\//, ""));
      const c = (e, t) => (
          e.undoManager.transact(() => {
            ...
            of(e, t),
              ...
              O(A(n.getElementsByTagName("*"), De.fromDom), (e) => {
                An(e, "data-mce-style") &&
                  !An(e, "style") &&
                  In(e, "data-mce-style").each((t) => Sn(e, "style", t));
              });
          }),
          k.some(!0)
        ),
        ...
        p = ((e, t, n, r, o = Pr) => {
          const s = {
            ...
            c = [
              ...
              Up(t, s, n, e),
              Hp(s),
              $p(s.tabSpaces, s.defaultProtocol),
            ],
            u = ((e, t, n, r, o) =>
              Fp(
                Ec.fallback,
        ...
        f = ((e = ac, t = fr.tabSpaces) =>
          Nc([$p(t, fr.defaultProtocol)], Fp(Ec.discard, Mp, [sp], !0), e))(
          o,
          h
        );
      return (
        ...
        }),
        {
          ...
          pasteEvent: (n) => {
            ((e) => {
              return ((t = e),
              k
                .from(t.clipboardData)
                .bind((e) => k.from(e.getData("text/html")))).bind((e) =>
                ((e) => W(e, "<google-sheets-html-origin"))(e)
                  ? k.some("googlesheets")
                  : ((e) =>
                      W(e, " data-ccp-props=") &&
                      W(e, " paraid=") &&
                  ...
                  ? k.some("mswordonline")
                  : ((e) =>
                      W(e, "<meta name=ProgId content=Excel.Sheet>") &&
                      !W(e, '="urn:schemas-microsoft-com:office:'))(e)
    ...
    df = (e) => {
      ...
      return I(
        null !==
          (n =
            null === (t = e.dataTransfer) || void 0 === t ? void 0 : t.items) &&
          void 0 !== n
          ? n
          : [],
        (e) => $(e.type, "image/")
                ...
                Mc(t).then((t) => {
                  const n = ((e) =>
                      A(e, (e) => {
                        ...
                        return Sn(t, "src", n), t.dom.outerHTML;
                      }).join(""))(t),
  ...
  tinymce.PluginManager.requireLangPack(
    "powerpaste",
    "ar,bg_BG,ca,cs,da,de,el,es,eu,fa,fi,fr_FR,he_IL,hi,hr,hu_HU,id,it,ja,kk,ko_KR,ms,nb_NO,nl,pl,pt_BR,pt_PT,ro,ru,sk,sl_SI,sv_SE,th_TH,tr,uk,vi,zh-Hans,zh_TW"
  ),
      ...
      ((e) => (t, r) => {
        ...
        ((e) => {
          const t = e.options.register,
            r = (e) => {
              const t =
                c(e) || ((e) => n(e) && T(["clean", "merge", "prompt"], e))(e);
              return t
                ? {
                    value: e,
                    valid: t,
        ...
        const o = ((e) => {
            ...
            return (
              e.on("keydown", (e) => {
                ((e) =>
                  tinymce.util.VK.metaKeyPressed(e) &&
                  86 === e.keyCode &&
                  e.shiftKey)(e) && n.set(!0);
              }),
        ...
        t.on("PreInit", () => {
          ...
          ((e, t) => {
            ...
            ae(t)
              ? ((e) => {
                  uf(e, e.getBody()), e.inline || uf(e, e.getDoc());
                })(t)
              : hf(t, 0, i, s);
        });
      })(undefined)
