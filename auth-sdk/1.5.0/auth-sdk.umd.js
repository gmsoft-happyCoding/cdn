(function(d,m){typeof exports=="object"&&typeof module!="undefined"?m(exports,require("react"),require("react-redux"),require("axios"),require("qs"),require("react-dom"),require("styled-components"),require("antd")):typeof define=="function"&&define.amd?define(["exports","react","react-redux","axios","qs","react-dom","styled-components","antd"],m):(d=typeof globalThis!="undefined"?globalThis:d||self,m(d.AuthSDK={},d.React,d.ReactRedux,d.axios,d.Qs,d.ReactDOM,d.styled,d.antd))})(this,function(d,m,B,We,Xe,Ze,Z,p){"use strict";function k(e){return e&&typeof e=="object"&&"default"in e?e:{default:e}}var l=k(m),Je=k(We),L=k(Xe),me=k(Ze),I=k(Z);/*! *****************************************************************************
...
`]))),gt=function(){m.useEffect(function(){return re(!1),function(){re(!0)}})},ht=function(){var e=m.useState(function(){return vt()})[0];return gt(),e?l.default.createElement(ft,null):null},Me,mt=q(),j=function(e){var t=e.children,n=e.width,r=e.getContainer,a=J(e,["children","width","getContainer"]);return a.visible!==!0?null:l.default.createElement(Z.StyleSheetManager,{target:mt},l.default.createElement(l.default.Fragment,null,l.default.createElement(ht,null),l.default.createElement(p.Modal,s({getContainer:r||q,width:n},a),l.default.createElement(p.ConfigProvider,{getPopupContainer:st},t))))},H=function(e){return function(t){return p.Modal[e](s({getContainer:q},t))}};j.info=H("info"),j.success=H("success"),j.error=H("error"),j.warning=H("warning"),j.confirm=H("confirm"),j.destroyAll=p.Modal.destroyAll;var Q="ant",V=function(){},pt=I.default(j)(Ae||(Ae=O([`
  &&& .`,`-modal-body {
...
`],[`
  font-size: 16px;
  font-weight: 700;
`]))),kt=function(e){var t,n,r,a=e.me,o=m.useContext(U).toCenterPage;return l.default.createElement(Lt,null,l.default.createElement(p.Menu,{mode:"vertical"},l.default.createElement(p.Menu.Item,{key:"avatar"},l.default.createElement(xt,{path:(t=a.additionalInformation)===null||t===void 0?void 0:t.avatar})),l.default.createElement(p.Menu.Item,{key:"name"},a.realName&&l.default.createElement("a",{onClick:o},l.default.createElement(zt,null,a.realName)),((n=a.org)===null||n===void 0?void 0:n.orgName)&&l.default.createElement(be,null,(r=a.org)===null||r===void 0?void 0:r.orgName)),l.default.createElement(p.Menu.Divider,null),l.default.createElement(p.Menu.Item,{key:"logout"},l.default.createElement(jt,null))))},je,Se,Le,xe,Ht=I.default(Pe)(ze||(ze=O([`
  &&& {
    height: 24px;
    width: 24px;
    vertical-align: middle;
