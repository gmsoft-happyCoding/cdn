...
`]))),ft=function(){m.useEffect(function(){return re(!1),function(){re(!0)}})},gt=function(){var e=m.useState(function(){return st()})[0];return ft(),e?u.default.createElement(vt,null):null},Me,ht=K(),T=function(e){var t=e.children,n=e.width,r=e.getContainer,a=Z(e,["children","width","getContainer"]);return a.visible!==!0?null:u.default.createElement(X.StyleSheetManager,{target:ht},u.default.createElement(u.default.Fragment,null,u.default.createElement(gt,null),u.default.createElement(p.Modal,s({getContainer:r||K,width:n},a),u.default.createElement(p.ConfigProvider,{getPopupContainer:dt},t))))},H=function(e){return function(t){return p.Modal[e](s({getContainer:K},t))}};T.info=H("info"),T.success=H("success"),T.error=H("error"),T.warning=H("warning"),T.confirm=H("confirm"),T.destroyAll=p.Modal.destroyAll;var q="ant",Q=function(){},mt=I.default(T)(Ae||(Ae=O([`
  &&& .`,`-modal-body {
