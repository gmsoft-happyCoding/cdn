(function(d,m){typeof exports=="object"&&typeof module!="undefined"?m(exports,require("react"),require("react-redux"),require("axios"),require("qs"),require("react-dom"),require("styled-components"),require("antd")):typeof define=="function"&&define.amd?define(["exports","react","react-redux","axios","qs","react-dom","styled-components","antd"],m):(d=typeof globalThis!="undefined"?globalThis:d||self,m(d.AuthSDK={},d.React,d.ReactRedux,d.axios,d.Qs,d.ReactDOM,d.styled,d.antd))})(this,function(d,m,B,We,Xe,Ze,X,p){"use strict";function z(e){return e&&typeof e=="object"&&"default"in e?e:{default:e}}var l=z(m),Je=z(We),L=z(Xe),me=z(Ze),I=z(X);/*! *****************************************************************************
...
`]))),ft=function(){m.useEffect(function(){return re(!1),function(){re(!0)}})},gt=function(){var e=m.useState(function(){return st()})[0];return ft(),e?l.default.createElement(vt,null):null},Me,ht=K(),j=function(e){var t=e.children,n=e.width,r=e.getContainer,a=Z(e,["children","width","getContainer"]);return a.visible!==!0?null:l.default.createElement(X.StyleSheetManager,{target:ht},l.default.createElement(l.default.Fragment,null,l.default.createElement(gt,null),l.default.createElement(p.Modal,s({getContainer:r||K,width:n},a),l.default.createElement(p.ConfigProvider,{getPopupContainer:ct},t))))},H=function(e){return function(t){return p.Modal[e](s({getContainer:K},t))}};j.info=H("info"),j.success=H("success"),j.error=H("error"),j.warning=H("warning"),j.confirm=H("confirm"),j.destroyAll=p.Modal.destroyAll;var q="ant",Q=function(){},mt=I.default(j)(Ae||(Ae=O([`
  &&& .`,`-modal-body {
...
`],[`
  font-size: 16px;
  font-weight: 700;
`]))),zt=function(e){var t,n,r,a=e.me,i=m.useContext(U).toCenterPage;return l.default.createElement(St,null,l.default.createElement(p.Menu,{mode:"vertical"},l.default.createElement(p.Menu.Item,{key:"avatar"},l.default.createElement(Lt,{path:(t=a.additionalInformation)===null||t===void 0?void 0:t.avatar})),l.default.createElement(p.Menu.Item,{key:"name"},a.realName&&l.default.createElement("a",{onClick:i},l.default.createElement(xt,null,a.realName)),((n=a.org)===null||n===void 0?void 0:n.orgName)&&l.default.createElement(be,null,(r=a.org)===null||r===void 0?void 0:r.orgName)),l.default.createElement(p.Menu.Divider,null),l.default.createElement(p.Menu.Item,{key:"logout"},l.default.createElement(bt,null))))},je,Se,Le,xe,kt=I.default(Ce)(ze||(ze=O([`
  &&& {
    height: 24px;
    width: 24px;
    vertical-align: middle;
