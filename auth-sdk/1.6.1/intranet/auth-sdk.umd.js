...
`]))),at=function(){m.useEffect(function(){return ne(!1),function(){ne(!0)}})},it=function(){var e=m.useState(function(){return nt()})[0];return at(),e?l.default.createElement(rt,null):null},fe,ot=G(),T=function(e){var t=e.children,n=e.width,r=e.getContainer,a=Z(e,["children","width","getContainer"]);return a.visible!==!0?null:l.default.createElement(X.StyleSheetManager,{target:ot},l.default.createElement(l.default.Fragment,null,l.default.createElement(it,null),l.default.createElement(p.Modal,s({getContainer:r||G,width:n},a),l.default.createElement(p.ConfigProvider,{getPopupContainer:tt},t))))},k=function(e){return function(t){return p.Modal[e](s({getContainer:G},t))}};T.info=k("info"),T.success=k("success"),T.error=k("error"),T.warning=k("warning"),T.confirm=k("confirm"),T.destroyAll=p.Modal.destroyAll;var K="ant",q=function(){},ut=D.default(T)(ge||(ge=O([`
  &&& .`,`-modal-body {
...
`],[`
  font-size: 16px;
  font-weight: 700;
`]))),yt=function(e){var t,n,r,a=e.me,i=m.useContext(H).toCenterPage;return l.default.createElement(Dt,null,l.default.createElement(p.Menu,{mode:"vertical"},l.default.createElement(p.Menu.Item,{key:"avatar"},l.default.createElement(Nt,{path:(t=a.additionalInformation)===null||t===void 0?void 0:t.avatar})),l.default.createElement(p.Menu.Item,{key:"name"},a.realName&&l.default.createElement("a",{onClick:i},l.default.createElement(It,null,a.realName)),((n=a.org)===null||n===void 0?void 0:n.orgName)&&l.default.createElement(Ie,null,(r=a.org)===null||r===void 0?void 0:r.orgName)),l.default.createElement(p.Menu.Divider,null),l.default.createElement(p.Menu.Item,{key:"logout"},l.default.createElement(Ot,null))))},ye,Pe,Te,Ce,Pt=D.default(we)(be||(be=O([`
  &&& {
    height: 24px;
    width: 24px;
    vertical-align: middle;
...
`]))),Tt=p.Typography.Text,Ct=D.default(Tt)(_e||(_e=O([`
  &&& {
    max-width: 150px;
    vertical-align: middle;
  }
