(function(d,m){typeof exports=="object"&&typeof module!="undefined"?m(exports,require("react"),require("react-redux"),require("qs"),require("axios"),require("react-dom"),require("styled-components"),require("antd")):typeof define=="function"&&define.amd?define(["exports","react","react-redux","qs","axios","react-dom","styled-components","antd"],m):(d=typeof globalThis!="undefined"?globalThis:d||self,m(d.AuthSDK={},d.React,d.ReactRedux,d.Qs,d.axios,d.ReactDOM,d.styled,d.antd))})(this,function(d,m,B,Ye,Ge,Ke,Z,E){"use strict";function z(e){return e&&typeof e=="object"&&"default"in e?e:{default:e}}var l=z(m),b=z(Ye),qe=z(Ge),le=z(Ke),D=z(Z);/*! *****************************************************************************
...
`]))),it=function(){m.useEffect(function(){return ne(!1),function(){ne(!0)}})},ot=function(){var e=m.useState(function(){return rt()})[0];return it(),e?l.default.createElement(at,null):null},fe,ut=K(),T=function(e){var t=e.children,n=e.width,r=e.getContainer,a=J(e,["children","width","getContainer"]);return a.visible!==!0?null:l.default.createElement(Z.StyleSheetManager,{target:ut},l.default.createElement(l.default.Fragment,null,l.default.createElement(ot,null),l.default.createElement(E.Modal,s({getContainer:r||K,width:n},a),l.default.createElement(E.ConfigProvider,{getPopupContainer:nt},t))))},H=function(e){return function(t){return E.Modal[e](s({getContainer:K},t))}};T.info=H("info"),T.success=H("success"),T.error=H("error"),T.warning=H("warning"),T.confirm=H("confirm"),T.destroyAll=E.Modal.destroyAll;var q="ant",Q=function(){},lt=D.default(T)(ge||(ge=O([`
  &&& .`,`-modal-body {
...
`],[`
  font-size: 16px;
  font-weight: 700;
`]))),Pt=function(e){var t,n,r,a=e.me,i=m.useContext(R).toCenterPage;return l.default.createElement(Nt,null,l.default.createElement(E.Menu,{mode:"vertical"},l.default.createElement(E.Menu.Item,{key:"avatar"},l.default.createElement(It,{path:(t=a.additionalInformation)===null||t===void 0?void 0:t.avatar})),l.default.createElement(E.Menu.Item,{key:"name"},a.realName&&l.default.createElement("a",{onClick:i},l.default.createElement(yt,null,a.realName)),((n=a.org)===null||n===void 0?void 0:n.orgName)&&l.default.createElement(Ie,null,(r=a.org)===null||r===void 0?void 0:r.orgName)),l.default.createElement(E.Menu.Divider,null),l.default.createElement(E.Menu.Item,{key:"logout"},l.default.createElement(wt,null))))},ye,Pe,Te,Ce,Tt=D.default(we)(be||(be=O([`
  &&& {
    height: 24px;
    width: 24px;
    vertical-align: middle;
...
`]))),Ct=E.Typography.Text,bt=D.default(Ct)(_e||(_e=O([`
  &&& {
    max-width: 150px;
    vertical-align: middle;
  }
